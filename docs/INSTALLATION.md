...
DriveSweep is free and open source. The public `v0.4.6` app is ad-hoc signed, not Apple-notarized. The methods below let you run it locally without an Apple Developer subscription.
...
2. Verify the download before opening it. For `v0.4.6`:

   ```sh
   shasum -a 256 ~/Downloads/DriveSweep.dmg
   ```

   The expected digest is `07be0521e0409a4822b775227916838e055d590e534eb4cb21e73d9850afa8f8`.
